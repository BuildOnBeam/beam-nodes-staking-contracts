 ...
 *    ```bash
 *    # Dry run (simulation)
 *    forge script contracts/validator-manager/scripts/DeployValidatorManagerImplementation.s.sol --rpc-url https://build.onbeam.com/rpc/testnet --slow --optimize --optimizer-runs 200 -vvvvv --private-key $PK_TESTNET
 *
 *    # Live run
 *    forge script contracts/validator-manager/scripts/DeployValidatorManagerImplementation.s.sol --rpc-url https://build.onbeam.com/rpc/testnet --slow --optimize --optimizer-runs 200 -vvvvv --private-key $PK_TESTNET --broadcast --verify --verifier sourcify
 *    ```
