...
contract FeeFlowControllerUpgradeable is Initializable {
    ...
    /// @notice This initializer performs parameter validation and sets the initial values for the contract.
    function initialize(
        uint256 initPrice,
    ...
    /// @dev Provides the sender of the current execution context
